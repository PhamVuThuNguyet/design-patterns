...
class IAbstractProductA(metaclass=ABCMeta):
    """
...
class IAbstractProductB(metaclass=ABCMeta):
    """
...
class ProductB1(IAbstractProductB):
    ...
    Product A1. Nevertheless, it accepts any instance of IAbstractProductA as an
    argument.
    """
...
class ProductB2(IAbstractProductB):
    ...
    def another_useful_function_b(self, collaborator: IAbstractProductA):
        """
        The variant, Product B2, is only able to work correctly with the
        variant, Product A2. Nevertheless, it accepts any instance of
        IAbstractProductA as an argument.
        """
        result = collaborator.useful_function_a()
...
def client_code(factory: IAbstractFactory) -> None:
    ...
    types: IAbstractFactory and IAbstractProduct. This lets you pass any factory
